...
public class C08AssertionInfo {
    ...
    public void hardAssertion() {
        ...
        System.out.println("Testing the equality of 3=3");
        Assert.assertEquals(3, 3); //passed
        // Assert.assertTrue(3==3); //passed

        System.out.println("Testing the equality of 3=4");
        ...
        Assert.assertEquals(3, 3); //will not be evaluated
    ...
    public void softAssertion() {
        ...
        System.out.println("Testing the equality of 3=5");
